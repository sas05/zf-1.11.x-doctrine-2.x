...
class Zend_Pdf_Resource_Image_Png extends Zend_Pdf_Resource_Image
{
    ...
    public function __construct($imageFileName)
    {
        ...
        $decodeParms['Colors'] = new Zend_Pdf_Element_Numeric((($color == Zend_Pdf_Resource_Image_Png::PNG_CHANNEL_RGB || $color == Zend_Pdf_Resource_Image_Png::PNG_CHANNEL_RGB_ALPHA)
                    ? (3) : (1)));
